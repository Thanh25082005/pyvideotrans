...
""")
    ...
    _fill_menu(ui.menu_Key, [
        ui.actionchatgpt_key, ui.actiontrans_api,
    ])

    _fill_menu(ui.menu_TTS, [
        ui.actiontts_refaudio, ui.actionopenaitts_key, ui.actiontts_api, ])

    _fill_menu(ui.menu_RECOGN, [
        ui.actionopenairecognapi_key,
        ui.actionrecognapi, ui.actionsttapi, ])
